!(function (c) {
  ...
  (t.prototype.respChart = function (t, e, r, a) {
    var o,
      ...
      s = c(t).parent();
    switch ((t.attr('width', c(s).width()), e)) {
      case 'Line':
        o = new Chart(i, { type: 'line', data: r, options: a });
        break;
      case 'Doughnut':
        o = new Chart(i, { type: 'doughnut', data: r, options: a });
        break;
      case 'Pie':
        o = new Chart(i, { type: 'pie', data: r, options: a });
        break;
      case 'Bar':
        o = new Chart(i, { type: 'bar', data: r, options: a });
        break;
      case 'Radar':
        o = new Chart(i, { type: 'radar', data: r, options: a });
        break;
      case 'PolarArea':
        o = new Chart(i, { data: r, type: 'polarArea', options: a });
    }
    return o;
  }),
    (t.prototype.initCharts = function () {
      ...
      0 < c('#high-performing-product').length &&
        ...
        [].push(
          this.respChart(c('#high-performing-product'), 'Bar', t, {
